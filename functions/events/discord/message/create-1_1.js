//Scripted by, 𝐃𝐚𝐌𝐲𝐬𝐭𝐢𝐜𝐒𝐤𝐲𝐥𝐞𝐫#4247 & MEIRABA#2222 | Any questions DM skyler.
//Make sure to define your prefix in Env Var.
//Hope this command is useful to all!
const lib = require('lib')({token: process.env.STDLIB_SECRET_TOKEN});

if (context.params.event.content.startsWith(`${process.env.PREFIX}afk`)) {
  ...
  context.params.event.content.startsWith(`${process.env.PREFIX}unafk`)
) {
